...
void Setup() //Setups for game
{
    gameOver = false;
    dir = STOP;
    x = width/2; //To center the snake on the map (x)
    y= height/2; //To center the snake on the map (y)
...
void Logic()
{
    ...
    /* Uncomment this to make your snake move through the wall and appear through other side of the wall.
    if(x >= width) x = 0;
